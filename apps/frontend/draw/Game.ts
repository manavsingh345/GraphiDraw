...
export class Game {
  ...
  private draftShapeId: string | null = null;
  ...
  private newShapeId() {
    return typeof crypto !== "undefined" && "randomUUID" in crypto
      ? crypto.randomUUID()
      : `shape_${Math.random().toString(36).slice(2, 10)}`;
  }
  ...
  private initMouseHandlers() {
    ...
    this.onMouseDown = (e: MouseEvent) => {
      ...
      if (this.selectedTool === "rect" || this.selectedTool === "circle") {
        this.draftShapeId = this.newShapeId();
      }
      ...
      if(this.selectedTool === 'pencil'){
        ...
        this.currentStrokeId = this.newShapeId();
        return;
      }
    ...
    this.onMouseUp = () => {
      ...
      if (this.selectedTool === "pencil") {
        shape = {
            id: this.currentStrokeId ?? this.newShapeId(),
            type: "pencil",
    ...
    this.onMouseMove = (e: MouseEvent) => {
      ...
      if (this.selectedTool === "rect") {
        ...
        this.draftShape = {
          id: this.draftShapeId ?? this.newShapeId(),
          type: "rect",
          x,
          y,
          width,

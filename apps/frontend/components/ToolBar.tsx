import { Circle, Eraser, Hand, MousePointer2, Pencil, RectangleHorizontal, Text, Trash } from "lucide-react";
...
export default function ToolBar({
  ...
  return (
    <div className="fixed top-5 left-1/2 -translate-x-1/2 z-50 rounded-xl border border-slate-200/70 bg-white/90 px-2.5 py-1.5 shadow-lg shadow-slate-900/10 backdrop-blur-md">

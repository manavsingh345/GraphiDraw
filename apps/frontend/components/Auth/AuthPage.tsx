    ...
    <div className="min-h-screen bg-background flex">
      <div className="hidden lg:flex lg:w-1/2 bg-primary/5 items-center justify-center p-12">
        <div className="max-w-md text-center">
          <div className="w-32 h-32 bg-primary rounded-2xl flex items-center justify-center mx-auto mb-8 shadow-sketch sketch-border">
            <Pencil className="w-16 h-16 text-primary-foreground" />
          </div>
          ...
          <div className="mt-12 flex justify-center gap-4">
            ...
            <div className="w-14 h-14 bg-secondary rounded-lg sketch-border rotate-12" />
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-card sketch-border shadow-sketch p-8 rounded-xl">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                ...
                <span className="bg-card px-3 text-muted-foreground">GraphiDraw</span>
              </div>
            </div>

            <div className="grid grid-cols-2 gap-3">
              {/* <Button variant="outline" className="sketch-border">
